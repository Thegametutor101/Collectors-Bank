...
class ModelMtgCard {
  ...
  final List<String> multiverse_ids;
  final int mtgo_id;
  ...
  static ModelMtgCard fromJson(Map<String, Object?> json) => ModelMtgCard(
      all_parts:
          _loopRelatedCardObjects(json["all_parts"] as Map<String, String>),
      ...
      card_faces: _loopCardFaces(json["card_faces"] as Map<String, String>),
      cardmarket_id:
      ...
      finishes:
          CollectorsBankHelperFunctions.addListString(json["finishes"] as List),
      flavor_name:
      ...
      image_uris: ImageUris.fromJson(json["image_uris"] as Map<String, String>),
      keywords: CollectorsBankHelperFunctions.addListString(json["keywords"] as List),
      lang: json["lang"] as String,
      layout: json["layout"] as String,
      legalities: Legalities.fromJson(json["legalities"] as Map<String, String>),
      life_modifier: CollectorsBankHelperFunctions.checkIfStringNull(json["life_modifier"] as List),
      ...
      multiverse_ids: CollectorsBankHelperFunctions.addListString(json["multiverse_ids"] as List),
      ...
      prices: Prices.fromJson(json["prices"] as Map<String, String>),
      ...
      purchase_uris: PurchaseUris.fromJson(json["purchase_uris"] as Map<String, String>),
      rarity: json["rarity"] as String,
      related_uris: RelatedUris.fromJson(json["related_uris"] as Map<String, String>),
  ...
  static List<RelatedCardObjects> _loopRelatedCardObjects(
      Map<String, dynamic> json) {
    List<RelatedCardObjects> relatedCardObjects = [];
    for (var i = 0; i < json.length; i++) {
      relatedCardObjects.add(RelatedCardObjects(
  ...
  static List<CardFaces> _loopCardFaces(Map<String, dynamic> json) {
    List<CardFaces> relatedCardObjects = [];
    for (var i = 0; i < json.length; i++) {
      relatedCardObjects.add(CardFaces(
          artist:
              CollectorsBankHelperFunctions.checkIfStringNull(json["artist"]),
          artist_id: CollectorsBankHelperFunctions.checkIfStringNull(
              json["artist_id"]),
          cmc: CollectorsBankHelperFunctions.checkIfDoubleNull(json["cmc"]),
          color_indicator: CollectorsBankHelperFunctions.addListString(
              json["color_indicator"]),
          colors: CollectorsBankHelperFunctions.addListString(json["colors"]),
          defense:
          ...
          image_uris: ImageUris.fromJson(json["colors"]),
          layout:
              CollectorsBankHelperFunctions.checkIfStringNull(json["layout"]),
          loyalty:
              CollectorsBankHelperFunctions.checkIfStringNull(json["loyalty"]),
          mana_cost: CollectorsBankHelperFunctions.checkIfStringNull(
              json["mana_cost"]),
          name: CollectorsBankHelperFunctions.checkIfStringNull(json["name"]),
          object:
              CollectorsBankHelperFunctions.checkIfStringNull(json["object"]),
          oracle_id: CollectorsBankHelperFunctions.checkIfStringNull(
              json["oracle_id"]),
